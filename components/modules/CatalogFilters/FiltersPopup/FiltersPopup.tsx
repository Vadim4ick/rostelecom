...
import { removeOverflowHiddenBody, showCountMessage } from '@/lib/utils/common'
...
const FiltersPopup = ({
  ...
  const { itemVariants, sideVariants, popupZIdx } = useMenuAnimation(
    105,
    filtersPopup
  )
